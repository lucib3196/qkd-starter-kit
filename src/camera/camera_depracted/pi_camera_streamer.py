...
class PiVideo:
    ...
    def start(self):
        ...
        self.capture_thread = threading.Thread(
            target=self._capture_frames, daemon=True, name="CaptureThread"
        )
            ...
            try:
                ...
                if self.clients > 0 or self.frame_buffer is None:
                    ...
                    if self.frame_count % 300 == 0:
                        logging.info(
                            f"Stream stats - Frame: {self.frame_count}, "
    ...
    def generate_frames():
        ...
        try:
            ...
            with stream_instance.clients_lock:
                stream_instance.clients -= 1
                logging.info(
                    f"Client disconnected. Remaining clients: {stream_instance.clients}"
                )
...
if __name__ == "__main__":
    ...
    stream = PiVideo(
        calibrated_camera=calibrated_camera, framerate=60, brightness=0.0, contrast=1.0
    ).start()
